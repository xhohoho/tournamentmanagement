          ...
          <div className="flex items-center justify-between px-5 py-3 border-b t-border shrink-0">
            ...
            {isAdmin && players.length > 0 && (
              <button
                ...
                onMouseEnter={e => {
                  e.currentTarget.style.color = 'var(--accent-red)'; e.currentTarget.style.borderColor = 'var(--accent-red)'
                }
                onMouseLeave={e => {
                  e.currentTarget.style.color = 'var(--text-muted)'; e.currentTarget.style.borderColor = 'var(--border-mid)'
                }}
                onClick={clearQueue}
              >
                Clear All
