  ...
  return (
    ...
    >
      <div className="t-surface border t-border rounded-2xl p-7 w-[360px] max-w-[95vw] animate-scale-in shadow-xl">
        ...
        <p className="t-muted text-sm mb-5">Enter password to unlock edit mode.</p>
        ...
        <div className="mt-5 border-t t-border pt-4">
          <p className="font-['DM_Mono'] text-[10px] t-dim mb-2 tracking-widest">CHANGE PASSWORD (must be unlocked)</p>
